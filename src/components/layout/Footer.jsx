    ...
    <footer className="bg-primary-900 dark:bg-black text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-heading text-xl font-bold uppercase tracking-wide">{import.meta.env.VITE_SITE_NAME || 'Dematiq'}</h3>
            </div>
        ...
        <div className="border-t border-primary-700 mt-8 pt-8 text-center text-primary-300 text-sm">
          &copy; {currentYear} {import.meta.env.VITE_SITE_NAME || 'Dematiq'}. Todos los derechos reservados.
        </div>
      </div>
    </footer>
  )
